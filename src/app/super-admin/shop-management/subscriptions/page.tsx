        ...
        <div className="shop-details-split-grid">
          ...
          <section className="shop-details-section">
            ...
            <div className="shop-details-card-grid shop-details-card-grid-compact">
              <article className="shop-details-card"><span>Example Shop</span><strong>{selectedSubscription.shop}</strong></article>
              <article className="shop-details-card"><span>Accounts</span><strong>1 Owner + 4 Salesmen</strong></article>
              <article className="shop-details-card"><span>Amount</span><strong>৳50</strong></article>
            </div>
          </section>
        </div>
        <section className="shop-details-section">
  ...
  return (
    <>
      <section className="master-category-page">
        ...
        <div className="purchase-report-grid-two shop-management-grid-two">
          <section className="admin-dashboard-panel purchase-report-panel profit-loss-formula-card">
            <div className="purchase-report-panel-header">
              <div>
                <h3>Billing Calculation</h3>
                <p>Subscriptions are calculated directly from billable account counts per shop.</p>
              </div>
            </div>
          ...
          <section className="admin-dashboard-panel purchase-report-panel shop-management-subscription-note">
            <div className="purchase-report-panel-header">
              <div>
                <h3>Account Billing Logic</h3>
                <p>Every shop always includes one owner account, and each salesman increases the monthly bill by ৳10.</p>
              </div>
            </div>
            <div className="shop-management-inline-metrics">
              <article>
                <span>Example Shop</span>
                <strong>Rahman Store</strong>
              </article>
              <article>
                <span>Accounts</span>
